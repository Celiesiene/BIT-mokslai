...
app.get('/barsukas', (req, res) => {
  ...
  app.get('/barsukas/:color/:size', (req, res) => {
    ...
    // const{color, size} = req.params gaima ir taip uzrasyti
    res.send(`<h1 style="color: ${color}; font-size: ${size}px;">Hello, Barsukas!</h1>`)
  });
//siunciam kazka dinamisko
...
//siunciam didelisu kiekius informacijos, taip pat ta info kuria norim paslepti, pvz password


app.get('/success', (req, res) => {
  res.send('<h1>Formą  gavome!</h1>');
});
